...
########################################connecting to db and fetch last record in db
...
def disco(word1, word2):
	s = str("java -jar /home/siavash/Desktop/semantic-similarity-tool/lib/assets/disco-2.1.jar /home/siavash/Desktop/semantic-similarity-tool/lib/assets/enwiki-20130403-word2vec-lm-mwl-lc-sim/ -s2 " + word1 + " " + word2)
	(a, b) = commands.getstatusoutput(s)
	if float(b) >= 0:
		print(word1," and ",word2,"  disco is " + b)
		return b
	else:
		print("disco can not find any similarity")
		return 0
